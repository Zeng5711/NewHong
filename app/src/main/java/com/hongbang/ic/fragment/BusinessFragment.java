...
import com.hongbang.ic.api.request.BusinessDetailParams;
 ...
 */
public class BusinessFragment extends BaseMainFragment implements SwipeRefreshLayout.OnRefreshListener,
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mCategoryView = new BusinessCategoryView(getActivity(),
                AppConstants.BUSINESS_CATEGORY_ICONS, AppConstants.BUSINESS_CATEGORY_NAMES,
                AppConstants.BUSINESS_CATEGORY_ID);
        ...
        requestData(AppConstants.BUSINESS_CATEGORY_ID[0], 1);
    }
    ...
    public void onHiddenChanged(boolean hidden) {
        ...
        if (!hidden) {
            ...
            mListAdapter.notifyDataSetChanged();
            mCurrentPage = 1;
            requestData(AppConstants.BUSINESS_CATEGORY_ID[0], mCurrentPage);
    ...
    private void requestData(int categoryId, int pageNo) {
        ...
        mCurrentRequest = app.data().getBusinessList(mCategoryId, pageNo, this);
    }
    ...
    private void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (info != null) {
            BusinessDetailParams params = new BusinessDetailParams(info.id);
            Intent intent = new Intent(getActivity(), WebViewActivity.class);
            intent.putExtra(WebViewActivity.EXTRA_TITLE, getString(R.string.module_business));
